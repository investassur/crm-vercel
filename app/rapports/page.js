...
export default function RapportsPage() {
  ...
  const loadDashboardData = async () => {
    ...
    const mockData = {
      ...
      ageRepartition: [
        { tranche: "60-65", count: 23 },
        { tranche: "65-70", count: 45 },
        { tranche: "70-75", count: 38 },
        { tranche: "75-80", count: 28 },
        { tranche: "80+", count: 15 },
      ],
    }
...
- **Focus recommandé**: Assurance dépendance (marché en croissance)
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      <SidebarNavigation currentPage="rapports" />
